...
export default function SettingsPage() {
  const { currentUser, fullname, username, getCurrentProfileUserAsync } =
    useUserStore();
  ...
  return (
    <div className="mx-auto mt-8 flex max-w-3xl flex-col gap-y-8 px-4 text-primary dark:bg-stone-900 ">
      <ChangeProfileDialog>
        <Button
          size="lg"
          className="flex h-auto w-full items-center justify-between px-0 dark:hover:bg-stone-800  "
          variant="ghost"
        >
      ...
      <section>
        ...
        <ModeToggle>
          <Button
            size="lg"
            className="flex h-16 w-full items-center px-0 dark:hover:bg-stone-800"
            variant="ghost"
          >
      ...
      <section>
        ...
        <Button
          size="lg"
          className="flex h-16 w-full flex-col items-start px-0 dark:hover:bg-stone-800 "
          variant="ghost"
        >
        ...
        <ChangePasswordDialog>
          ...
          >
            ...
            <span className="block text-left text-xs font-normal text-muted-foreground">
              Click here to reset your password of your account.
            </span>
          </Button>
        </ChangePasswordDialog>
      </section>
